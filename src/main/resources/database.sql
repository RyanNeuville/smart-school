...
-- Insert dummy data
INSERT INTO etudiant (id, matricule, nom, prenom, date_naissance, email, telephone, date_inscription, statut)
VALUES ('1', '2024001', 'Doe', 'John', '2000-01-01', 'john.doe@example.com', '123456789', NOW(), 'ACTIF')
ON CONFLICT (matricule) DO NOTHING;

INSERT INTO evaluation (id, matiere, date_examen, coefficient)
VALUES ('1', 'Java Programming', '2024-01-15', 3)
ON CONFLICT (id) DO NOTHING;

INSERT INTO note (id, valeur, commentaire, date_saisie, etudiant_id, evaluation_id)
